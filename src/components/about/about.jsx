                ...
                <div className="max-w-screen-xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row gap-20 md:gap-0 items-center">
                        ...
                        <div className="text-secondary mt-10 md:w-1/2">
                            <p className="text-sm md:text-base">Hello there! My name is Angga Haady Wijaya and i&apos;m a front-end developer based in Medan, specializing in crafting visually appealing and user-friendly websites. Currently pursuing my undergraduate degree in informatics, I focus on frontend web development, translating design concepts into seamless, responsive interfaces that enhance user experiences.</p>
