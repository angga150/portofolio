    ...
    return (
        ...
        <div className="flex gap-10 md:gap-14 xl:gap-20 h-full pt-40 md:pb-20">
            ...
            <div className="hidden md:flex flex-col items-center gap-6 h-full">
                ...
                <div className="flex flex-col gap-6 text-3xl text-primary">
                    ...
                    <div className="hover:text-secondary" id="cursorHover">
                        <a href="https://www.instagram.com/rtrivaldo20/" target="_blank">
                    ...
                    {/* github */}
                    <div className="hover:text-secondary" id="cursorHover">
                        <a href="https://github.com/rtrivaldo">
                    ...
                    {/* linkedin */}
                    <div className="hover:text-secondary" id="cursorHover">
                        <a href="https://www.linkedin.com/in/rivaldo-tandoko/">
            ...
            <div className=" lg:mt-20 w-full">
                ...
                <h1 className="mt-4 md:mt-6 text-4xl md:text-5xl xl:text-6xl font-bold text-primary/90">Rivaldo Tandoko.</h1>
                <h2 className="mt-2 md:mt-4 text-4xl md:text-5xl xl:text-6xl font-bold text-primary/70" id="typeIt"></h2>

                <p className="mt-10 md:w-2/3 xl:w-1/2 text-sm md:text-base text-secondary">I specialize in frontend web development, focusing on creating visually stunning and highly functional interfaces with a keen eye for detail. My goal is to deliver seamless user experiences through responsive designs that meet the highest standards of performance and aesthetics.</p>

                <div className="mt-10">
                    <a href="mailto:rtrivaldo05@gmail.com">
                        <Button text="Hire me!" />
                    </a>
                </div>
            </div>
